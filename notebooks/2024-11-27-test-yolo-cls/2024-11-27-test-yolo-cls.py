...
if __name__ == "__main__":
    ...
    # Run predictions
    results = model.predict(source=input_folder, task='classify', save=True, save_dir=output_folder) 
    ...
    for class_index, summary in class_summary.items():
        class_accuracy = summary["correct"] / summary["total"] * 100 if summary["total"] > 0 else 0
        print(f"Class {class_index} - Total: {summary['total']}, Correct: {summary['correct']}, Accuracy: {class_accuracy:.2f}%")
