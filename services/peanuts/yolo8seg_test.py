...
if __name__ == "__main__":
    # Parameters
    image_folder = Path(r"C:\My storage\Python projects\DataSets\peanuts\task3\test_model")  # Path to the images folder
    model_path = Path(r"C:\My storage\Python projects\MLBox\models\Yolo\best.pt" ) # Path to the YOLOv8 model file
